...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "HTN Vitals Tracker",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "HTN Vitals Tracker",
    ...
    "welcome_sign": "Welcome to HTN Admin",

    # Copyright on the footer
    "copyright": f"Copyright © HTN Vitals Tracker @ {datetime.now().year}. All Rights reserved.",
    ...
    "topmenu_links": [
        ...
        {"name": "HTN Dashboard",  "url": "/", "permissions": ["auth.view_user"]},

        # external url that opens in a new window (Permissions can be added)
        {"name": "Support", "url": "https://github.com/smockin", "new_window": True},
    ...
    "icons": {
        ...
        "datamanager.facilities": "fas fa-hospital",
        "datamanager.patients": "fas fa-users",
        "datamanager.htnvisits": "fas fa-calendar",
    },
